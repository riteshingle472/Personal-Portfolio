...
document.getElementById("contact").addEventListener("submit", (data) => {
  ...
  let contact = document.querySelector("#phoneNumber");

  if (contact.value.length === 10) {
    document.querySelector("#numberErr").style.display = "none";
  } else {
    document.querySelector("#numberErr").style.display = "block";
    document.querySelector("#numberErr").style.color = "red";
    document.querySelector("#numberErr").textContent = "Must be 10 digit";
    valid = false;
  }
